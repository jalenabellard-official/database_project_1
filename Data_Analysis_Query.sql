...
-- run queries individually by highlighting and executing
...
WHERE num_of_companies > 5;
-- Use query below for Substantial Layoffs findings:
-- WHERE num_of_companies > 5 AND total_laid_off > 10000
